"""OpenAI provider implementation using instructor."""
...
class OpenAIProvider(BaseProvider):
    ...
    def _initialize_sync_client(self) -> None:
        ...
        if self._sync_client is None:
            ...
            self._sync_client = instructor.from_openai(base_client)
    ...
    def _initialize_async_client(self) -> None:
        ...
        if self._async_client is None:
            ...
            self._async_client = instructor.from_openai(base_client)
